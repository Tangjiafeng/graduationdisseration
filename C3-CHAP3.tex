...
\end{table}
综上可以发现，McEliece方案在推荐参数下，直接攻击方法是无法影响其安全性的。后续的密码分析研究，在以上攻击的基础上进行了改进，使得工作因子尽可能下降，这也间接的导致了McEliece方案加强安全性的设计，以及对公钥尺寸的缩小\cite{Berger2009Reducing}。本章最后会介绍一种新的加密方案变体。
